...
<div class="d-md-flex">
    ...
    <div class="col-md-5 p-md-5 content-infos">
      ...
      <?php
        if ( $facebook_url ) { ?>
      <li class="social-list"><a class="link-social" href="https://<?php echo esc_html( $facebook_url ); ?>" target="_blank"><i class="fab <?php echo esc_html( $facebook_icon ); ?>"></i></a></li>
    <?php
  }
        if ( $linkedin_url ) { ?>
      <li class="social-list"><a class="link-social" href="https://<?php echo esc_html( $linkedin_url ); ?>" target="_blank"><i class="fab <?php echo esc_html( $linkedin_icon ); ?>"></i></a></li>
      <?php
    }
    if ( $instagram_url ) { ?>
      <li class="social-list"><a class="link-social" href="https://<?php echo esc_html( $instagram_url ); ?>" target="_blank"><i class="fab <?php echo esc_html( $instagram_icon ); ?>"></i></a></li>
      <?php
    } ?>
    </ul>
  </div>
